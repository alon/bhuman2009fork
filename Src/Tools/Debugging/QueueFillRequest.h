...
#ifndef __QueueFillRequest_h_
#define __QueueFillRequest_h_
...
public: // methods
	 ...
	 */
	QueueFillRequest(Behavior behavior, Filter filter, Target target, long timingMilliseconds)
		: behavior(behavior),
		  filter(filter),
		  target(target),
