/**
* @file ControllerQt/Representations/ModuleInfo.h
*
...
#ifndef __ModuleInfo_h_
#define __ModuleInfo_h_
...
public:
  ...
  */
  std::string sendRequest(Out& stream) const;
};

#endif //__ModuleInfo_h_
