...
#ifndef ALLOGODETECTIONPROXY_H_
# define ALLOGODETECTIONPROXY_H_
# include "alproxy.h"
# include "allogodetectionproxyposthandler.h"

namespace AL
{
  /**
   * ALLogoDetectionProxy gives acces to all bound methods of the module.
   */
  class ALLogoDetectionProxy : public ALProxy
    {
       public:
        ...
        * Local Constructor
        */
       ALLogoDetectionProxy(ALPtr<ALBroker> pBroker) : ALProxy(pBroker, "ALLogoDetection")
       { post.setParent( (ALProxy*)this );}

       /**
        * Remote Constructor
        */
       ALLogoDetectionProxy(std::string pIP, int pPort) : ALProxy("ALLogoDetection", pIP, pPort)
       { post.setParent( (ALProxy*)this );}

       /**
        * \brief: Implements thread wrappers around methods
       */
       ALLogoDetectionProxyPostHandler post;
