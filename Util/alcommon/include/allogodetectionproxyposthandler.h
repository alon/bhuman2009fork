...
#ifndef ALLOGODETECTIONPROXYPOSTHANDLER_H_
# define ALLOGODETECTIONPROXYPOSTHANDLER_H_
# include "alproxy.h"
namespace AL
{
  class ALLogoDetectionProxy;

  /**
   * ALLogoDetectionProxyPostHandler gives acces to all bound methods of the module, using a thread around each call.
   * Long running tasks can be stopped by calling stop(id) with the id returned by the post. 
   */
  class ALLogoDetectionProxyPostHandler
    {
       friend class ALLogoDetectionProxy;
       ...
       ALLogoDetectionProxyPostHandler() : fParent(NULL)
       {}
