...
namespace AL
{
  ...
  /**
   * ALLandMarkDetectionProxyPostHandler gives acces to all bound methods of the module, using a thread around each call.
  ...
  class ALLandMarkDetectionProxyPostHandler
    {
       ...
       ALLandMarkDetectionProxyPostHandler() : fParent(NULL)
       {}
