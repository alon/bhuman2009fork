...
# include "alproxy.h"
# include "allandmarkdetectionproxyposthandler.h"

namespace AL
{
  /**
   * ALLandMarkDetectionProxy gives acces to all bound methods of the module.
   */
  class ALLandMarkDetectionProxy : public ALProxy
    {
       public:
        ...
        * Local Constructor
        */
       ALLandMarkDetectionProxy(ALPtr<ALBroker> pBroker) : ALProxy(pBroker, "ALLandMarkDetection")
       { post.setParent( (ALProxy*)this );}

       /**
        * Remote Constructor
        */
       ALLandMarkDetectionProxy(std::string pIP, int pPort) : ALProxy("ALLandMarkDetection", pIP, pPort)
       { post.setParent( (ALProxy*)this );}

       /**
        * \brief: Implements thread wrappers around methods
       */
       ALLandMarkDetectionProxyPostHandler post;
