...
#ifndef ALSONARPROXYPOSTHANDLER_H_
# define ALSONARPROXYPOSTHANDLER_H_
# include "alproxy.h"
namespace AL
{
  class ALSonarProxy;
  ...
  /**
   * ALSonarProxyPostHandler gives acces to all bound methods of the module, using a thread around each call.
   * Long running tasks can be stopped by calling stop(id) with the id returned by the post. 
   */
  class ALSonarProxyPostHandler
    {
       friend class ALSonarProxy;
       ...
       ALSonarProxyPostHandler() : fParent(NULL)
       {}
