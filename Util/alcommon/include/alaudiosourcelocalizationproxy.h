...
# include "alproxy.h"
# include "alaudiosourcelocalizationproxyposthandler.h"

namespace AL
{
  /**
   * ALAudioSourceLocalizationProxy gives acces to all bound methods of the module.
   */
  class ALAudioSourceLocalizationProxy : public ALProxy
    {
       public:
        ...
        * Local Constructor
        */
       ALAudioSourceLocalizationProxy(ALPtr<ALBroker> pBroker) : ALProxy(pBroker, "ALAudioSourceLocalization")
       { post.setParent( (ALProxy*)this );}

       /**
        * Remote Constructor
        */
       ALAudioSourceLocalizationProxy(std::string pIP, int pPort) : ALProxy("ALAudioSourceLocalization", pIP, pPort)
       { post.setParent( (ALProxy*)this );}

       /**
        * \brief: Implements thread wrappers around methods
       */
       ALAudioSourceLocalizationProxyPostHandler post;
        ...
        */
       void setParam ( std::string pParam, ALValue pValue )
       {
         callVoid( "setParam", pParam, pValue );
       }
