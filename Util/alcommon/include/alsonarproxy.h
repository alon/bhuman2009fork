...
# include "alproxy.h"
# include "alsonarproxyposthandler.h"

namespace AL
{
  /**
   * ALSonarProxy gives acces to all bound methods of the module.
   */
  class ALSonarProxy : public ALProxy
    {
       public:
        ...
        * Local Constructor
        */
       ALSonarProxy(ALPtr<ALBroker> pBroker) : ALProxy(pBroker, "ALSonar")
       { post.setParent( (ALProxy*)this );}

       /**
        * Remote Constructor
        */
       ALSonarProxy(std::string pIP, int pPort) : ALProxy("ALSonar", pIP, pPort)
       { post.setParent( (ALProxy*)this );}

       /**
        * \brief: Implements thread wrappers around methods
       */
       ALSonarProxyPostHandler post;
