...
#ifndef ALINERTIALPROXYPOSTHANDLER_H_
# define ALINERTIALPROXYPOSTHANDLER_H_
# include "alproxy.h"
namespace AL
{
  class ALInertialProxy;

  /**
   * ALInertialProxyPostHandler gives acces to all bound methods of the module, using a thread around each call.
   * Long running tasks can be stopped by calling stop(id) with the id returned by the post. 
   */
  class ALInertialProxyPostHandler
    {
       friend class ALInertialProxy;
       ...
       ALInertialProxyPostHandler() : fParent(NULL)
       {}
